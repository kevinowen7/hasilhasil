...
def makeWebhookResult(req):  
    ...
    return {
        "speech": req.get("result").get("originalRequest").get("source"),
        "displayText": req.get("result").get("originalRequest").get("source"),
        #"data": {},
        #"contextOut": [],
        "source": req.get("result").get("originalRequest").get("source")
    }
